...
WeaponCache.kHealAmount = 25
WeaponCache.kResupplyInterval = .8
gWeaponCacheHealthHeight = 1.4
-- Players can use menu and be supplied by armor inside this range
WeaponCache.kResupplyUseRange = 2.5

if Server then
    Script.Load("lua/ModularExos/WeaponCache_Server.lua")
elseif Client then
    Script.Load("lua/ModularExos/WeaponCache_Client.lua")
end
